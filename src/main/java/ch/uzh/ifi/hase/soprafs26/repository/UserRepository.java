...
public interface UserRepository extends JpaRepository<User, Long> {
	...
	@Query("SELECT u FROM User u JOIN Friend f ON f.friend = u WHERE (f.user.id = :userId OR u.id = :userId) AND u.clickSpeedHighScore IS NOT NULL ORDER BY u.clickSpeedHighScore DESC")
